...
with DAG(
    ...
    t3 = BashOperator(
        task_id='dbt_run',
        bash_command='cd /opt/airflow/dbt_project/mimicToOmop && rm -rf /tmp/dbt_packages && mkdir /tmp/dbt_packages && /home/airflow/.local/bin/dbt deps && /home/airflow/.local/bin/dbt run --profiles-dir .'
    )
